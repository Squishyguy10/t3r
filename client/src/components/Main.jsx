...
function Main() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            scrollTop > elementOffset-windowHeight+500 ? setIsVisible(true) : setIsVisible(false);
    ...
    return (
        <div>
            ...
            {/* What is T3R? */}
            <div className='container px-5 pt-20 mx-auto text-center lg:px-40 pb-80'>
                <div id="fade-in-text" className={`transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}> 
                    <div className='flex flex-col w-full mb-40'>
                        <BookOpenIcon className='mx-auto inline-block w-10 mt-40 text-green-500' />
                        
                        <h1 className='sm:text-4xl text-5xl font-medium title-font mb-4 text-green-600 py-3 font-display'>
                            What is T3R? 
                        </h1>
                        <p className='lg:w-3/4 mx-auto leading-relaxed text-base text-green-500'>
